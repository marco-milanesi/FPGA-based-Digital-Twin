// -------------------------------------------------------------
// 
// File Name: D:\Github\embedded-DT\Simulink\step_antiwindup\motor_dtf_antiwindup\DT.v
// Created: 2023-04-29 01:25:40
// 
...
module DT
  ...
  wire signed [127:0] gain_mul_temp;  // sfix128_En66
  ...
  wire signed [127:0] gain_mul_temp_1;  // sfix128_En66
  ...
  assign gain_mul_temp = 64'sh001A36E2EB1C432D * Discrete_Time_Integrator1_indtc;
  assign Discrete_Time_Integrator1_u_gain = {{2{gain_mul_temp[127]}}, gain_mul_temp[127:66]};
  ...
  assign gain_mul_temp_1 = 64'sh001A36E2EB1C432D * Discrete_Time_Integrator_indtc;
  assign Discrete_Time_Integrator_u_gain = {{2{gain_mul_temp_1[127]}}, gain_mul_temp_1[127:66]};
