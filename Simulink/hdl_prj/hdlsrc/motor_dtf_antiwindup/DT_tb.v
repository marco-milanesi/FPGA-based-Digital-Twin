...
module DT_tb;
  ...
  // Data source for ti
  assign rawData_ti = (rdEnb == 1'b0 ? 10'sb0000000000 :
              10'sb0000000000);
  ...
  always @(rawData_ti or rdEnb or tb_enb_delay)
  ...
  // Data source for kp
  assign rawData_kp = (rdEnb == 1'b0 ? 10'sb0000000000 :
              10'sb0000000100);
  ...
  always @(rawData_kp or rdEnb or tb_enb_delay)
  ...
  // Data source for SP
  assign rawData_SP = (rdEnb == 1'b0 ? 10'sb0000000000 :
              10'sb0000111100);
  ...
  always @(rawData_SP or rdEnb or tb_enb_delay)
    begin : stimuli_SP_3
      if (tb_enb_delay == 1'b0) begin
        SP_offset <= 10'b0;
      end
  ...
  assign i_action_ref = i_action_expected_1;
