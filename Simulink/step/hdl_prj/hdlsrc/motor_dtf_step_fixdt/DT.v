// -------------------------------------------------------------
// 
// File Name: hdl_prj\hdlsrc\motor_dtf_step_fixdt\DT.v
// Created: 2023-04-21 03:37:51
// 
...
// 
// Module: DT
// Source Path: motor_dtf_step_fixdt/DT
// Hierarchy Level: 0
// 
// Simulink model description for motor_dtf_step_fixdt:
// 
...
module DT
  ...
  wire signed [79:0] Product1_mul_temp;  // sfix80_En42
  ...
  wire signed [79:0] Product_mul_temp;  // sfix80_En42
  ...
  assign Product1_out1 = Product1_mul_temp[73:10];
  ...
  assign Product_out1 = Product_mul_temp[73:10];


  assign Add1_out1 = Product_out1 + Discrete_Time_Integrator1_x_reg;


  assign Discrete_Time_Integrator_indtc = Add1_out1;
